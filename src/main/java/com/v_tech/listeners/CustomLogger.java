...
public class CustomLogger implements Logger {
	...
	public void info(String message) {
		CustomListener.step.get().log(Status.INFO, message);
		logger.info("Framework: " + message);
	}

	@Override
	public void warn(String message) {
		CustomListener.step.get().log(Status.WARNING, message);
		logger.warn("Framework: " + message);
	}

	@Override
	public void debug(String message) {
		logger.debug("Framework: " + message);
	}
	...
	public void fatal(String message) {
		logger.fatal("Framework: " + message);
	}

	@Override
	public void log(Level level, String message) {
		logger.log(level, "Framework: " + message);

	}

	@Override
	public void trace(String message) {
		logger.trace("Framework: " + message);
	}
